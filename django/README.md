...
2. `project_slug` - Project identifier / Python package name (slugified)
   - Used throughout the codebase, e.g. in `import` statements, as the Django project/module name, and in the GitLab CI/CD configuration.
   - Use a valid Python module name (typically lowercase letters, numbers, and underscores; must not start with a number).
